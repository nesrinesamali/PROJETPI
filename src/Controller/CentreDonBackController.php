...
{
    #[Route('/show_in_map/{id}', name: 'app_don_map', methods: ['GET'])]
    public function Map( CentreDon $id,EntityManagerInterface $entityManager ): Response
    {

        $id = $entityManager
            ->getRepository(CentreDon::class)->findBy( 
                ['id'=>$id ]
            );
        return $this->render('centre_don_back/map.html.twig', [
            'centre_dons' => $id,
        ]);
    }
